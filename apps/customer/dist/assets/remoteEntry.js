...
const currentImports = {};
      ...
      let moduleMap = {
"./MicroApp":()=>{
      dynamicLoadingCss([], false, './MicroApp');
      return __federation_import('./__federation_expose_MicroApp-71abbb88.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__customer__' + exposeItemName;
